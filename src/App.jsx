...
function App() {
  ...
  return (
    <>
    <Navbar/>
      <div className="block md:mx-auto my-8 rounded-xl p-5 md:w-1/2 bg-slate-200 min-h-[80vh]">
        <h1 className='font-bold text-center text-xl'>iTask - Manage your Todos at one place</h1>
        <div className="addtodo flex flex-col gap-4 my-5">
          <h2 className='text-lg font-bold'>Add a Todo</h2>
          <input onChange={handleChange} value={todo} type="text" className='w-full text-wrap rounded-xl py-1 px-3' />  
          <button onClick={handleAdd} disabled={todo.length<=3} className='bg-violet-800 hover:bg-violet-950 p-2 py-1 text-sm font-bold disabled:bg-violet-600 text-white rounded-md mx-6'>Save</button>
        </div>
